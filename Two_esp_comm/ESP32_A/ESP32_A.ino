  ...
  while (1) {
    ...
    if ((sample_error = dht11.read(&temperature, &humidity, NULL)) != SimpleDHTErrSuccess) {
      ...
      if (Mode == 0) {
        ...
        mqttClient.publish("esp32_A/temperature", tempString);
        mqttClient.publish("esp32_A/humidity", humString);
...
void mqtt_connect() {
  ...
  if (mqttClient.connected()) {
    ...
    */
    ...
    mqttClient.subscribe("dataESP2", 0);
    mqttClient.subscribe("encryptESP2", 0);
